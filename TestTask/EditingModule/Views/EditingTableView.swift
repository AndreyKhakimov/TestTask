...
final class EditingTableView: UITableView {
    ...
    override init(frame: CGRect, style: UITableView.Style) {
        ...
        register(TextViewTableViewCell.self, forCellReuseIdentifier: TextViewTableViewCell.identifier)
        register(DatePickerTableViewCell.self, forCellReuseIdentifier: DatePickerTableViewCell.identifier)
        register(PickerViewTableViewCell.self, forCellReuseIdentifier: PickerViewTableViewCell.identifier)
    ...
    public func editUserModel() {
        ...
        userModel.dateOfBirth = birthdayCell.getCellValue()
...
extension EditingTableView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 3:
            ...
            cell.configure(name: nameField, date: userModel.dateOfBirth.getDateFromString())
